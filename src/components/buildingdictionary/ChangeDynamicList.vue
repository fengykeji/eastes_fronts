...
<style>
#ChangeDynamicList	.m_bottom{
		margin-bottom:20px;
		border:1px solid #ddd;
	}
#ChangeDynamicList		.m_top{
		margin-top:50px;
	}
#ChangeDynamicList		.Commissio_title{
		line-height:32px;
	}
#ChangeDynamicList		.check-basetitle{
		height:40px;
		line-height:40px;
		color:#fff;
	}
#ChangeDynamicList		.el-button{
		margin-top:3px!important;
	}
	
#ChangeDynamicList		.info{
    border-radius: 10px;
    line-height: 20px;
    padding: 10px;
    margin: 10px;
