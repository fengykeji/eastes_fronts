    ...
    <div id="madd">
        ...
        <div class="content">
            <el-form ref="form" :model="form" label-width="100px" class="left">
                ...
                <el-upload class="avatar-uploader" :action="url + '/user/project/upload'" :show-file-list="false" name="img_url" :http-request="customUpload">
...
export default {
  ...
  methods: {
    submit() {
        ...
        this.$http({
            url:this.url+'/user/project/addNav',
            method: "POST",
            headers: {
    ...
    customUpload(file){
        ...
        url:this.url + '/user/project/upload',
        // url:
        ...
        //   console.log(res)
          this.showUrl = showImgServer.showImgServer + res.data.data.img_url;
      });
    }
    // upload() {
