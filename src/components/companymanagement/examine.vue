<template>
    <div id="examine">
        <el-row type="flex" justify="space-between" class="examine-title">
            ...
            <el-col :span="6">
                <el-button-group>
                    ...
                    <el-button type="info" plain size="small">停用</el-button>
                </el-button-group>
            </el-col>
        </el-row>
        <el-table :data="Data" border style="width: 100%" ref="multipleTable" tooltip-effect="dark" size='mini'>
            ...
            <el-table-column prop="projectOfAccess" label="项目对接人">
            </el-table-column>
    ...
    getexaminelist() {
      for (let i = 1; i < 100; i++) {
        this.tableData.push({
          ...
          applicationTime: "2017/12/12"
        });
      }
      this.page()
    },
      check(){
      this.$router.push({path: '/index/examinecheck'})
    },
    page() {
